...
var renderer = new THREE.WebGLRenderer({
    antialias: true //allows for smooth shading of shadows (i think...)
});
...
cube.castShadow = true; //@IMPORTANT: allows the cube to cast a shadow object. 
scene.add(cube);
...
spotLight.castShadow = true; //IMPORTANT: allows the spotlight to be able to cast a shadow with its light
spotLight.angle = Math.PI / 6;
scene.add(spotLight)
spotLight.penumbra = 0.3; //softens the edge

var spotLightHelper = new THREE.SpotLightHelper(spotLight); //this just shows the current location and orientation of the spotlight. 
...
//does the raycast, finds intersection with dome, and sets position of spotlight aswell as little helper indicator sphere
